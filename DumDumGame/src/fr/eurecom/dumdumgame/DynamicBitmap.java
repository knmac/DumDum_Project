...
public class DynamicBitmap {
    ...
    public DynamicBitmap(Bitmap[] images, Point position, int startIndex, int width, int height)
    {
        this.images = images;
    ...
    public DynamicBitmap(Bitmap image, Point position, int startIndex, int width, int height)
    {
    ...
    protected void constructor(Bitmap[] images, Point position, int startIndex, int width, int height)
    {
        this.images = images;
        this._position = position;
        this._currentIndex = startIndex;
    ...
    {
        Rect boundary = new Rect(_position.x, _position.y, _position.x + _width, _position.y + _height);
    ...
    public void showEx(Canvas canvas, int srcX, int srcY, int srcWidth, int srcHeight)
    {      
        Rect srcRect = new Rect(srcX, srcY, srcX + srcWidth, srcY + srcHeight);
        Rect dstRect = new Rect(_position.x + srcX, _position.y + srcY, _position.x + srcX + srcWidth, _position.y + srcY + srcHeight);
        canvas.drawBitmap(images[_currentIndex], srcRect, dstRect, new Paint());           
    }
