...
public class GameDuoClient extends Game {
	...
	public GameDuoClient(int bet) {
		...
		Toast.makeText(App.getMyContext(), "You are Player 2", Toast.LENGTH_SHORT).show();
	...
	public void Action(Point mousePos, Object o, MouseState mouseState) {
		...
		// receive force to trigger opp ball
	}
