...
public class Blackhole {
	...
	public Blackhole(Point center) {
		this(center, Parameters.dTeleRadius);
	}

	public Blackhole(Point center, int radius) {
		this.center = center;
		this.radius = radius;
		Point imgTopLeft = new Point(center.x - radius, center.y - radius);
		bhImg = new DynamicBitmap(Parameters.bmpTeleporter, imgTopLeft, 0,
				2 * radius, 2 * radius);
	}
